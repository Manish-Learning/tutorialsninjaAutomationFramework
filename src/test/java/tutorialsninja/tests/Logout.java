...
public class Logout extends Base{
	...
	public void verifyUIOfLogoutOptionAndAccountLogoutPage() {
		...
		if(prop.getProperty("browserName").equals("firefox")) {
			...
			CommonUtils.takeScreenshot(headerOptions.getDriver(),"\\Screenshots\\expectedChromeLogoutOption.png");
			...
			CommonUtils.takeScreenshot(headerOptions.getDriver(),"\\Screenshots\\expectedEdgeLogoutOption.png");
		...
		accountLogoutPage = headerOptions.selectLogoutOption();
		if(prop.getProperty("browserName").equals("firefox")) {
			CommonUtils.takeScreenshot(headerOptions.getDriver(),"\\Screenshots\\expectedFirefoxAccountLogoutPage.png");
			...
			CommonUtils.takeScreenshot(headerOptions.getDriver(),"\\Screenshots\\expectedChromeAccountLogoutPage.png");
			...
			CommonUtils.takeScreenshot(headerOptions.getDriver(),"\\Screenshots\\expectedEdgeAccountLogoutPage.png");
